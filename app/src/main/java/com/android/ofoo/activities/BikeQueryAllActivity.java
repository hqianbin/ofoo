...
public class BikeQueryAllActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_bike_all);
        ...
        mBtnBikeQuery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(strBikeNO.length() < 4){
                    Toast.makeText(BikeQueryAllActivity.this, "请输入正确的车牌号", Toast.LENGTH_LONG);
                }else{
                    List<BikeBean> bikeList =  new DbHelper<BikeBean>().queryForEq(BikeQueryAllActivity.this, BikeBean.class, "bike_no", strBikeNO);
                    if(bikeList == null || bikeList.size() == 0){
                        Intent intent = new Intent(BikeQueryAllActivity.this, BikeInsertActivity.class);
